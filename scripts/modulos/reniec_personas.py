    ...
    def insert(self, personas: dict):
        stm = (
            insert(reniec_personas).values(
                ...
                desconocido1=personas['desconocido1'],
                desconocido2=personas['desconocido2'],
                desconocido3=personas['desconocido3'],
                desconocido4=personas['desconocido4'],
                desconocido5=personas['desconocido5'],
                desconocido6=personas['desconocido6'],
                desconocido7=personas['desconocido7'],
                desconocido8=personas['desconocido8'],
                desconocido9=personas['desconocido9'],
                desconocido10=personas['desconocido10'],
                desconocido11=personas['desconocido11'],
